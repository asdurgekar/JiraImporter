...
public class Authentication {
    ...
    public static void main(String[] args) throws Exception {
        new Authentication().authenticateLoginLogoutExample(
                        "http://" + Constants.HOST + ":" +
    ...
    public void authenticateLoginLogoutExample(final String serverUrl,
        ...
        Authentication example = new Authentication();
...
"response from isAuthenticated means we're authenticated. that can't be.",
        ...
        Assert.assertTrue( "login did not cause creation of Light Weight Single Sign On(LWSSO) cookie.", con.getCookieString().contains("LWSSO_COOKIE_KEY"));
    ...
    public boolean login(String loginUrl, String username, String password)
        ...
        // "Basic ((username:password)<as bytes>)<64encoded>"
          //byte[] credBytes = ("" + ":" + "").getBytes();
    	byte[] credBytes=new GetCredentials().getAlmCredentials();
        ...
        System.out.println("Response:"+String.valueOf(response.getStatusCode()));
